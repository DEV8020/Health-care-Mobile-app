...
const AppBar = ({title,handleLogout,user,setUser}) => {
    
    const _handleProfile = () => {
        setUser("ProfileScreen");
    ...
    {user === "HomeScreen" && <Appbar.Action icon="account" size={30} color="white"  onPress={_handleProfile} />}
        {/* <Appbar.Action icon="setting" color="#2797F0"  onPress={_handleSettings} /> */}
        <Appbar.Action icon="logout" size={30} color="white" onPress={handleLogout} />
      </Appbar.Header>
